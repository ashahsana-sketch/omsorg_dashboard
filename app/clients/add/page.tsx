  ...
  const saveClientData = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Form clear karna chahein toh yeh line uncomment kar dein:
        // setName("");
      } else {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-6 space-y-6 bg-stone-50 min-h-screen">
      <div className="max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-teal-50/60 p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-2xl mx-auto">
