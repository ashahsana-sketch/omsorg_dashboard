      ...
      <main className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="bg-linear-to-r from-teal-700 to-teal-800 text-white p-6 md:p-8 rounded-2xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
           ...
           <div className="inline bg-teal-50 pb-2 rounded-2xl text-2xl text-teal-50 font-bold ">
          <NavLink href="/Roster">Open Care Roster View →</NavLink></div>
             
        </div>


        <section className="bg-teal-50 p-6 rounded-2xl border border-stone-200 shadow-xs space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-md font-bold text-teal-800">Facility & Care Moments Gallery</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {imageList.map((img) => (
              ...
              >
                ...
                />
                <h3 className="absolute bottom-1 right-1 bg-stone-900/60 text-white text-[11px] font-bold px-1.5 py-0.5 rounded">
                  #{img.id}
                </h3>
              </div>
            ))}
        ...
        <section className="bg-teal-50 p-6 rounded-2xl border border-stone-200 shadow-xs">
